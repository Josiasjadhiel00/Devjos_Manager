...
export const ClientProfileModal: React.FC<{
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-stretch sm:items-center justify-center sm:p-4 bg-black/70 backdrop-blur-xs">
      <div
        className="w-full h-full sm:h-auto max-w-4xl bg-slate-900 sm:border sm:border-slate-800 rounded-none sm:rounded-2xl shadow-2xl overflow-hidden flex flex-col sm:max-h-[90vh] animate-in zoom-in-95 duration-150"
